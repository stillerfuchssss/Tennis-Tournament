...
{isAdmin && (
  <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 grid md:grid-cols-4 gap-3 items-end">
    <div>
      ...
      <input value={plannerNewName} onChange={e => setPlannerNewName(e.target.value)} className="w-full p-3 border border-blue-300 rounded-lg text-sm bg-white" placeholder="Spielername"/>
    </div>
    <div>
      <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Geburtsdatum</label>
      <input type="date" value={plannerNewBirth} onChange={e => setPlannerNewBirth(e.target.value)} className="w-full p-3 border border-blue-300 rounded-lg text-sm bg-white"/>
    </div>
    <div>
    ...
    <div>
      ...
      <input value={plannerNewClub} onChange={e => setPlannerNewClub(e.target.value)} className="w-full p-3 border border-blue-300 rounded-lg text-sm bg-white" placeholder="Verein"/>
    </div>
